...
namespace WonderTools.FakeHttpClient.Tests
{
    public class ResponseBodyTests
    {
        ...
        public void When_request_then_use_content_response()
        {
            ...
            var content = "test";
            _messageHandler.WhenRequest().WhenUri(_defaultUri).Respond().SetResponseContent(content.CreateContent()).UseStatusCode(responseHttpCode);
        ...
        public void When_request_then_use_content_type_response()
        {
            ...
            _messageHandler.WhenRequest().WhenUri(_defaultUri).Respond().SetResponseContent(content.CreateContent().WithContentType
        ...
        public void When_request_then_use_content_range_response()
        {
            var responseHttpCode = HttpStatusCode.Accepted;
            var content = "test";
            _messageHandler.WhenRequest().WhenUri(_defaultUri).Respond().SetResponseContent(content.CreateContent().WithContentRange(22234, 62887922)).UseStatusCode(responseHttpCode);
        ...
        public void When_request_then_use_content_encoding_response()
        {
            ...
            _messageHandler.WhenRequest().WhenUri(_defaultUri).Respond().SetResponseContent(content.CreateContent().WithContentRange(22234, 62887922).WithContentEncoding(contentEncoding)).UseStatusCode(responseHttpCode);
        ...
        public void When_request_then_use_content_language_response()
        {
            ...
            _messageHandler.WhenRequest().WhenUri(_defaultUri).Respond().SetResponseContent(content.CreateContent().WithContentRange(22234, 62887922).WithContentEncoding(contentEncoding).WithContentLanguage(contentLanguage)).UseStatusCode(responseHttpCode);
